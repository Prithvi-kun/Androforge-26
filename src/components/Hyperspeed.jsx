  ...
  useEffect(() => {
    ...
    class App {
      ...
      init() {
        ...
        // Let the parent manage these events, or if managed internally:
    ...
    // Provide methods to manually trigger speedup/slowdown from the parent
    if (effectOptions.onAppCreated) {
        effectOptions.onAppCreated(myApp);
    }
